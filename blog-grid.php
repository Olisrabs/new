...
<html lang="en">
  <head>
    ...
    <!-- Title -->
    <title>KmEmpire - ONL_SHOPPING || Blog Grid Page</title>
      ...
      <div class="blog-wrapper py-3">
        <div class="container">
          <div class="section-heading d-flex align-items-center justify-content-between rtl-flex-d-row-r">
            <h6>Blog Grid</h6>
            <!-- Layout Options-->
            <div class="layout-options"><a class="active" href="blog-grid.php"><i class="ti ti-border-all"></i></a><a href="blog-list.php"><i class="ti ti-list-check"></i></a></div>
          </div>
            ...
            <div class="col-6 col-md-4 col-lg-3">
              <div class="card blog-card">
                ...
                <div class="post-content">
                  ...
                  <!-- Post Meta-->
                  <div class="post-meta d-flex align-items-center justify-content-between flex-wrap mb-2"><a><i class="ti ti-user"></i><?php echo $row['blog_upload'];?></a><span><i class="ti ti-calender"></i><?php echo date('jS-F-Y',strtotime($row['date']));?></span></div>
