      ...
      <div class="top-products-area py-3">
        <div class="container">
          <div class="section-heading d-flex align-items-center justify-content-between rtl-flex-d-row-r">
            <h6>Blog List</h6>
            <!-- Layout Options-->
            <div class="layout-options"><a href="blog-grid.php"><i class="ti ti-border-all"></i></a><a class="active" href="blog-list.php"><i class="ti ti-list-check"></i></a></div>
          </div>
            ...
            <div class="col-12 col-md-6">
              <div class="card blog-card list-card">
                ...
                <div class="post-content">
                  ...
                  <!-- Post Meta-->
                  <div class="post-meta d-flex align-items-center justify-content-between flex-wrap"><a href="#"><i class="ti ti-user"></i></i><?php echo $row['blog_upload'];?></a><span><i class="ti ti-calender"></i><?php echo date('jS-F-Y',strtotime($row['date']));?></span></div>
                </div>
              </div>
            </div>
            <?php }}?>
