        ...
        <div class="profile-wrapper-area py-3">
          ...
          <div class="card user-data-card">
            ...
            <form method="post">
                ...
                $sql="UPDATE user SET fullname='$fullname', username='$username', mob_num='$mob_num', email='$emailreg', `address`='$address' WHERE id='$_REQUEST[id]'";
              ...
              ?>
                <div class="mb-3">
                  ...
                  <input class="form-control" type="text" name="username" value="<?php echo $session_username;?>">
                </div>
                <div class="mb-3">
