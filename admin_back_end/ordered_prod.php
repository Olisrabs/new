...
<head>
    ...
    <title>KmEmpire - ONL_SHOPPING || All Orders Page</title>
    <!-- Google font-->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body order-datatable">
                                    <table class="display" id="basic-1">
                                        ...
                                        <?php
                                                    include('db_con.php');
                                                    $sql= "SELECT * FROM bill_details WHERE order_stat='Ordered' ORDER BY id DESC";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                       ...
                                                       elseif($row['pay_stat']=='Awaiting payment on delivery'){
                                                        echo "<span class='dropdown-item btn-info btn-pill btn-xsm'><i class='fa fa-calendar'></i>".$row['pay_stat']."</span>";
                                                        }
                                                ...
                                                <td>
                                                    <a href="view_receipt.php?order_id=<?php echo $row['order_id'];?>" title="Click to view receipt"><div class="d-flex align-items-center">
