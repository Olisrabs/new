                                ...
                                <div class="card-body">
                                    <div class="table-responsive table-desi">
                                        <table class="table all-package" id="editableTable">
                                            ...
                                            <?php
                                                    include('db_con.php');
                                                    $sql= "SELECT * FROM cart WHERE `status`='Returned' ORDER BY id DESC";
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-field="number">&#8358;<?php echo number_format($row['prod_price'], 2);?></td>
                                                ...
                                                <td>
                                                    <a href="return_goods.php?id=<?php echo $row['id'];?>" class="btn btn-info mt-md-0 mt-2">
