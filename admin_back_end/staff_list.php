                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex vendor-list">
                                                <img src="../staff/passport/<?php echo $row['passport'];?>" alt="Passport" width="80px" alt="" class="img-fluid img-40 rounded-circle blur-up lazyloaded">
                                        ...
                                        <td><?php echo $row['quan_name'];?></td>
                                        <td><?php echo $row['quan_numb'];?></td>
                                        <td><?php echo $row['quan_address'];?></td>
                                        <td><?php echo $row['exper'];?></td>
                                        <td>
                                            <img src="../staff/cv/<?php echo $row['cv'];?>" alt="" class="img-fluid img-30 me-2 blur-up lazyloaded" style="width: 155px;">
                                        </td>
                                        <td><?php
                                        ...
                                        <td>
                                            <div>
                                                <i class="fa fa-check me-2 font-success" title="Activate Staff Account"></i>
                                                <i class="fa fa-edit me-2 font-primary" title="Edit Staff Profile"></i>
                                                <i class="fa fa-trash font-danger" title="Delete Staff Account"></i>
                                            </div>
                                        </td>
                                        </tr>
                                        <?php }}?>
