                                        ...
                                        <div class="col-xl-7">
                                            <form class="needs-validation add-product-form" method="post" enctype="multipart/form-data" novalidate="">
                                                        <?php
                                                            ...
                                                            $sortBy=trim(addslashes($_REQUEST["sortBy"]));
                                                           ...
                                                           $check=mysqli_query($con, "SELECT * FROM add_product WHERE prod_name='$prod_name' OR prod_uin='$prod_uin'");
                                                           ...
                                                           echo"<script> alert('Product already exist')</script>";
                                                            ...
                                                            $sql="INSERT INTO add_product(prod_uin, categ_name, sub_catname, prod_type, prod_name, prod_price, prod_oldprice, `expiry_date`, prod_size, prod_disc, prod_stat, prod_sec, best_selling, related, sortBy, prod_quant, spec, prod_image1, prod_image) VALUES ('$APID','$categ_name','$sub_catname','$prod_type','$prod_name','$prod_price','$prod_oldprice',CURDATE(),'$prod_size','$prod_disc','$prod_stat','$prod_sec','','','$sortBy','$prod_quant','$spec','$prod_image1','$prod_image')";
                                                           ...
                                                           $messagereg="Error inserting record into database";
                                                            ...
                                                            echo "<script>alert ('Product has been Successfully added.')
                                                            location.href='product-review.php'</script>";
                                                            }}}}
                                                        ?>
                                                <div class="form">
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input class="form-control" id="validationCustomUsername" type="text"  name="prod_type" required="">
                                                        </div>
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input class="form-control" id="validationCustomUsername" type="text"  name="prod_name" required="">
                                                        </div>
                                                        <div class="invalid-feedback offset-sm-4 offset-xl-3">Looks good!</div>
                                                    </div>
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input class="form-control" id="validationCustomUsername" type="text"  name="prod_price" required="">
                                                        </div>
                                                        <div class="invalid-feedback offset-sm-4 offset-xl-3">Looks good!</div>
                                                    </div>
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input class="form-control" id="validationCustomUsername" type="text"  name="prod_oldprice" placeholder="Optional">
                                                        </div>
                                                        <div class="invalid-feedback offset-sm-4 offset-xl-3">Looks good!</div>
                                                    </div>
                                                </div>
                                                <div class="form">
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input class="form-control" id="validationCustomUsername" type="text"  name="prod_disc">
                                                        </div>
                                                        <div class="invalid-feedback offset-sm-4 offset-xl-3">Looks good!</div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="exampleFormControlSelect1" class="col-xl-3 col-sm-4 mb-0">Product Sorting :</label>
                                                        <div class="col-xl-8 col-sm-7">
                                                        <select class="form-control digits" id="exampleFormControlSelect1" name="sortBy" required="">
                                                                <option value="">--Select One--</option>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <fieldset class="qty-box col-xl-9 col-xl-8 col-sm-7">
                                                            <div class="input-group">
                                                                <input class="touchspin" type="text" value="1" name="prod_quant">
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="form-group mb-3 row">
    <label for="validationCustom02_1" class="col-xl-3 col-sm-4 mb-0">Upload Image 1 :</label>
    <div class="col-xl-8 col-sm-7">
        <input class="form-control" id="validationCustom02_1" type="file" name="prod_image1" required="" accept=".jpg,.jpeg,.png,.JPG,.JPEG,.PNG">
    </div>
    <div class="valid-feedback">Looks good!</div>
</div>
<div class="form-group mb-3 row">
    <label for="validationCustom02_2" class="col-xl-3 col-sm-4 mb-0">Upload Image 2 :</label>
    <div class="col-xl-8 col-sm-7">
        <input class="form-control" id="validationCustom02_2" type="file" name="prod_image" required="" accept=".jpg,.jpeg,.png,.JPG,.JPEG,.PNG">
    </div>
    <div class="valid-feedback">Looks good!</div>
</div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-sm-7 description-sm">
                                                            <textarea id="editor1" name="spec" cols="10" rows="4"></textarea>
                                                        </div>
