                                ...
                                <div class="card-body">
                                    <div class="table-responsive table-desi">
                                        <table class="table trans-table all-package">
                                            ...
                                            <?php
                                                    include('db_con.php');
                                                    $sql= "SELECT * FROM return_pay ORDER BY id DESC";
                                                ...
                                                <tr>
                                                    ...
                                                    <td><b><?php echo $row['ref_amt'];?></b></td>

                                                    <td><?php echo $row['bank'];?></td>

                                                    <td><?php echo $row['acc_numb'];?></td>
                                                ...
                                                <td>
                                                    <a data-bs-toggle="modal" data-original-title="test" href="#pendingreceipt<?php echo $row['Pay_id'];?>" title="Click to view receipt"><div class="d-flex align-items-center">
                                                        <img src="pay_receipt/<?php echo $row['pay_receipt'];?>" alt="" class="img-fluid img-30 me-2 blur-up lazyloaded">
                                                    </div></a>
                                                </td>

                                                 <td>
                                                    <a href="delete_returnpay.php?Pay_id=<?php echo $row['Pay_id'];?>" onclick="return confirm('Are you sure to delete this payment detail?')">
                                                        <i class="fa fa-trash" title="Delete payment"></i>
                                                    </a>
                                                </td>
                                                </tr>
                                               <?php }}?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><img src="pay_receipt/<?php echo $row['pay_receipt'];?>" alt="" style="width: 465px;"></p>
                </div>
