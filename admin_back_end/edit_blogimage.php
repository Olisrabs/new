                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="page-header-left">
                                    <h3>Blog
                                        <small>KmEmpire_onl_shopping || Admin panel</small>
                                    </h3>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="breadcrumb-item active">Change Blog Image</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-xl-7">
                                            <form class="needs-validation add-product-form" method="post" novalidate="" enctype="multipart/form-data">
                                                        <?php
                                                            ...
                                                            $sql="UPDATE blog SET blog_image1='$blog_image1', blog_image2='$blog_image2' WHERE id='$_REQUEST[id]'";
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="offset-xl-3 offset-sm-4 mt-4">
                                                            <button type="submit" name="save" class="btn btn-primary">Update Image</button>
