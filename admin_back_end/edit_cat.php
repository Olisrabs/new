                                            ...
                                            <form class="needs-validation add-product-form" novalidate=""  method="post" enctype="multipart/form-data">
                                                        <?php
                                                           ...
                                                           echo"<script> alert('Account already exist')</script>";
                                                            ...
                                                            $sql="UPDATE addnew_cat SET cat_uin='$cat_uin', cat_name='$cat_name', total_item='$total_item', disc='$disc', cat_image='$cat_image' WHERE id='$_REQUEST[id]'";
                                                ...
                                                <div class="form">
                                                    <div class="form-group mb-3 row" hidden>
                                                        ...
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input class="form-control" id="validationCustom02" type="text" name="cat_uin" value="<?php echo $CID?>" required="">
                                                        </div>
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input class="form-control" id="validationCustom01" type="text" name="cat_name" value="<?php echo $row['cat_name'];?>" required="">
                                                        </div>
                                                        <div class="valid-feedback">Looks good!</div>
                                                    </div>
                                                    <div class="form-group mb-3 row">
                                                        <label for="validationCustom02" class="col-xl-3 col-sm-4 mb-0">Total Items :</label>
                                                        <div class="col-xl-8 col-sm-7">
                                                            <input class="form-control" id="validationCustom02" type="text" name="total_item" value="<?php echo $row['total_item'];?>" value="Items" required="">
                                                        </div>
                                                        <div class="valid-feedback">Looks good!</div>
                                                    </div>
                                                </div>
                                                <div class="form">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-xl-8 col-sm-7">
                                                        <input class="form-control" id="validationCustom02" type="text" name="disc" value="<?php echo $row['disc'];?>">  
                                                        </div>
                                                        <div class="valid-feedback">Looks good!</div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="exampleFormControlSelect1" class="col-xl-3 col-sm-4 mb-0">Category Image :</label>
                                                        <div class="col-xl-8 col-sm-7">
                                                        <input class="form-control" id="validationCustom02" type="file" name="cat_image" value="<?php echo $row['cat_image'];?>" accept=".jpg,.jpeg,.png,.JPG,.JPEG,.PNG" required="">  
                                                        </div>
                                                        <div class="valid-feedback">Looks good!</div>
                                                    </div>
