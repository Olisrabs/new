...
<?php include('navbar.php');?>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <button type="button" class="btn btn-primary mt-md-0 mt-2" data-bs-toggle="modal" data-original-title="test" data-bs-target="#bystat">Transaction Report</button>
                                </div>
                                        ...
                                        <table class="table trans-table all-package">
                                            ...
                                            <?php
                                                    ...
                                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                        if (!empty($_POST['date_from']) && !empty($_POST['date_to']) && !empty($_POST['order_stat'])) {
                                                            $date_from = $_POST['date_from'];
                                                            $date_to = $_POST['date_to'];
                                                            $order_stat = $_POST['order_stat'];
                                                    $sql= "SELECT * FROM bill_details WHERE order_stat='$order_stat' AND `date` BETWEEN '$date_from' AND '$date_to' ORDER BY id DESC";
                                                ...
                                                <?php
                                                       ...
                                                       echo "<span class='dropdown-item btn-secondary btn-pill btn-xsm'><i class='fa fa-check'></i>".$row['order_stat']."</span>";
                                                       }
                                                       else{
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 footer-copyright text-start">
                            <p class="mb-0">Copyright 2025 © Multikart All rights reserved.</p>
                        </div>
 ...
 <div class="modal fade" id="bystat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title f-w-600" id="exampleModalLabel">Transaction Report By Status</h5>
                    ...
                    <form class="needs-validation" method="post">                          
                        <div class="form">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <select class="form-control" id="validationCustom02" name="order_stat">
