...
<html lang="en">
  <head>
    ...
    <!-- Title -->
    <title>KmEmpire - ONL_SHOPPING || Password Recovery Email Page</title>
              ...
              <form action="" method="post">
                <?php
                            ...
                            echo"<script> alert('No user is registered with this email address')</script>";
                               ...
                               //Finally send email
                               if ( $mail->send() ) {
                             echo "<script>alert ('Password recovery email has been successfully sent. Please check your inbox!')</script>";
                             }
                         }}
              ?>
                <div class="form-group text-start mb-4"><span>Email Address</span>
                  <label for="email"><i class="ti ti-user"></i></label>
                  <input class="form-control" id="email" type="text" placeholder="Input Your Resgistered Email Address">
                </div>
                <button class="btn btn-warning btn-lg w-100" type="submit">Send Email</button>
              </form>
            </div>
          </div>
        </div>
