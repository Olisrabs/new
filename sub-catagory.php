<?php
include('db_con.php');
if(isset($_REQUEST['subcat_name'])){
    $sql= "SELECT * FROM add_product WHERE sub_catname='$_REQUEST[subcat_name]'";
...
<html lang="en">
  <head>
    ...
    <!-- Title -->
    <title>KmEmpire - ONL_SHOPPING || Product Sub-Category Page</title>
    ...
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between rtl-flex-d-row-r">
        ...
        <div class="page-heading">
          <h6 class="mb-0"><?php echo $row['categ_name'];?></h6>
        </div>
        <!-- Filter Option-->
            ...
            <div class="col-6 col-md-4">
              <div class="card product-card">
                <div class="card-body">
                  ...
                  <!-- Thumbnail --><a class="product-thumbnail d-block" href="admin_back_end/prod_image1/<?php echo $row['prod_image1'];?>"><img class="mb-2" src="admin_back_end/prod_image1/<?php echo $row['prod_image1'];?>" alt=""></a>
