...
<html lang="en">
  <head>
    ...
    <!-- Title -->
    <title>KmEmpire - ONL_SHOPPING || Introduction Page</title>
  ...
  <body>
    ...
    <div class="get-started-btn"><a class="btn btn-warning btn-lg w-100" href="onboarding.php">Get Started</a></div>
