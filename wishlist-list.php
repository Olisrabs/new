      ...
      <div class="py-3">
        <div class="container">
          <div class="section-heading d-flex align-items-center justify-content-between rtl-flex-d-row-r">
            ...
            <!-- Layout Options-->
            <div class="layout-options"><a href="wishlist-grid.php?user_id=<?php echo $session_user_id;?>"><i class="ti ti-border-all"></i></a><a class="active" href="wishlist-list.php"><i class="ti ti-list-check"></i></a></div>
          </div>
          <?php
                                          include('db_con.php');
                                          $sql= "SELECT * FROM cart WHERE `status`='Available' AND user_id='$_REQUEST[user_id]' ORDER by id DESC";
                                          $result= mysqli_query($con, $sql);
              ...
              <div class="card horizontal-product-card">
                <div class="d-flex align-items-center">
                  <div class="product-thumbnail-side">
                    ...
                    <!-- Delete  --><a class="delete-btn" href="delete_wishlist.php?id=<?php echo $row['id'];?>"><i class="ti ti-trash" title="Delete Wishlist"></i></a>
                  </div>
                  <div class="product-description">
                    ...
                    <!-- Price -->
                    <p class="sale-price"><i class="ti ti-currency-dollar"></i>&#8358;<?php echo number_format($row['prod_price'], 2);?><span>&#8358;<?php echo number_format($row['prod_price'], 2);?></span></p>
                    <!-- Rating -->
                  </div>
                </div>
              </div>
