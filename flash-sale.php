...
<html lang="en">
  <head>
    ...
    <!-- Title -->
    <title>KmEmpire - ONL_SHOPPING || Flash Sale Products Page</title>
    ...
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between rtl-flex-d-row-r">
        ...
        <div class="page-heading">
          <h6 class="mb-0">Shop - Flash Sale Products</h6>
        </div>
        <!-- Filter Option-->
      ...
      <div class="top-products-area py-3">
        <div class="container">
          <div class="row g-2 rtl-flex-d-row-r">
            ...
            <?php
                    include('db_con.php');
                    $sql= "SELECT * FROM add_product WHERE prod_sec = 'Flash Sales'";
            ...
            <div class="col-4">
              ...
              <div class="card-body">
                  ...
                  <!-- Product Price -->
                  <p class="sale-price">&#8358;<?php echo number_format($row['prod_price'], 2);?><span class="real-price"> &#8358;<?php echo number_format($row['prod_oldprice'], 2);?></span></p>
                  <!-- Rating -->
                </div>
              </div>
            </div>
