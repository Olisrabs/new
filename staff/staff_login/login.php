<?php
	...
	//Checking is user existing in the database or not
        $query = "SELECT * FROM staff WHERE email='$email' AND `password`=PASSWORD('$password')";
        ...
        if($rows==1){
			...
			echo '<script type="text/javascript"> window.open("../admin_back_end/index_staff.php","_self");</script>'; // Redirect user to index.php
            }{
    echo "<script>alert('Invalid Staff Login Credential')</script>";
   }
    }
?>
...
<head>
    ...
    <title>KmEmpire - ONL_SHOPPING || Staff Login Page</title>
			...
			<div class="container">
                ...
                ?>
					...
					<img src="images/logo-2.png" alt="">
						<h2 style="margin-top: 30px;">Staff Login</h2>
					...
					<div class="input-group nm-gp">
						...
						<input type="text" class="form-control" name="email" id="inputUsername" tabindex="1" placeholder="Email Address" required="">
					</div>
					...
					<footer style="text-align: center; margin-top: 2rem; font-size: 0.75rem; color: #97a4af; font-weight: 400;">Don't have an account? <a class="nm-fs-1 nm-fw-bd" style="font-size: 0.75rem;" href="../register.php">Signup</a></footer>
				</form>
			</div>
		</div>
	</main>
